        ...
        <Container>
            <Header>
                <ViewIconHeader>
                    ...
                    <ViewIcon onPress={() => Alert.alert('Estoque baixo ⚠', 'Aqui aparecerão os produtos que estão com a quantidade em estoque menor ou igual a quantidade minima que você definiu ao cadastrar.')}>
